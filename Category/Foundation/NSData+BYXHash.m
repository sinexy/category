...
- (NSData *)byx_hmacMD5DataWithKey:(NSData *)key {
    return [self byx_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}
/**
 *  @brief  sha1Data NSData
 *
...
{
    return [self byx_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}
/**
 *  @brief  sha256Data NSData
 *
...
{
    return [self byx_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}
/**
 *  @brief  sha512Data NSData
 *
...
{
    return [self byx_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}


- (NSData *)byx_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
